INSERT INTO users(id, email, name) VALUES
    (1, 'anisio.tier@example.com', 'Anisio Tier'),
    (2, 'fidel.kutch@example.com', 'Fidel Kutch'),
    (3, 'alien.west@example.com', 'Alien West'),
    (4, 'alien.east@example.com', 'Alien East'),
    (5, 'william.bob@example.com', 'William Bob');
